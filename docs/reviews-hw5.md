...
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...but nevertheless, here is a track record that everyone is contributing a lot)|evidence in GH|1|2|2|2|2|
|Number of commits|in GH|3|3|3|3|3|
|Number of commits: by different people|in GH|2|2|2|2|2|
|Issues reports: there are **many**||1|0|0|1|3|
...
|Use of code coverage |config files in GH|3|3|2|3|3|
|Other automated analysis tools|config files in GH|3|2|2|2|2|
|Test cases exist|dozens of tests and those test cases are more than 30% of the code base|1|3|3|3|3|
|Test cases are routinely executed|E.g. travis-com.com or github actions or something|3|3|3|3|3|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up||2|3|3|0|3|
|Issues are discussed before they are closed|even if you discuss in slack, need a summary statement here|2|3|2|3|3|
|Chat channel: exists|Link or screenshots|3|3|3|3|3|
|Test cases: a large proportion of the issues related to handling failing cases.|If a test case fails, open an issue and fix it|3|2|2|1|2|
|Evidence that the whole team is using the same tools: everyone can get to all tools and files||3|3|3|3|3|
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)||0|0|0|3|0|
|Evidence that the members of the team are working across multiple places in the code base||3|3|3|2|3|
|Short release cycles | (hard to see in short projects) project members are committing often enough so that everyone can get your work|3|3|3|3|3|
